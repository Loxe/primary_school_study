...
function choice (right, index) {
    if (isAnimation === false) {
        ...
        if (right === true) {
            ...
            audioCorrect.play()
            banner.src = 'images/banner-red.png'
            switch (index) {
                case 0:
                    ball.className = 'roll1'
                    people2.src = 'images/people2-lose.png'
                    people3.src = 'images/people3-lose.png'
                    break
                case 1:
                    ball.className = 'roll2'
                    people1.src = 'images/people1-lose.png'
                    people3.src = 'images/people3-lose.png'
                    break
                case 2:
        ...
        setTimeout(function () {
            if (listIndex < (list.length - 1)) {
                ...
                people1.src = 'images/people1.png'
                people2.src = 'images/people2.png'
                people3.src = 'images/people3.png'
                ball.className = ''
                banner.src = 'images/banner-white.png'
            } else {
